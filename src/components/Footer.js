  ...
  return (
    <>
        <footer className="py-4 text-center bg-darker text-gray-600 text-xs">
            ...
            <div className="py-4">
                <a href="https://github.com/shanemaglangit" target="_blank" rel="noreferrer" className="px-2 text-orange-500">GitHub</a>
                <a href="https://www.facebook.com/Scoobidiboopao" target="_blank" rel="noreferrer" className="px-2 text-orange-500">LinkedIn</a>
                <a href="https://www.aedin.com/in/shanemaglangit/" target="_blank" rel="noreferrer" className="px-2 text-orange-500">Facebook</a>
            </div>
