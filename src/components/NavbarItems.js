    ...
    return (
        <>
            ...
            <div className="text-sm md:flex-grow md:text-right">
                ...
                <button onClick={() => scrollTo('#contact')} className="font-medium text-gray-500 mt-4 md:bg-primary md:hover:bg-orange-700 md:text-sm md:text-white md:font-semibold md:mt-0 md:py-2 md:px-4 md:rounded-full focus:outline-none">Have a chat</button>
            </div>
        </>
    )
}
