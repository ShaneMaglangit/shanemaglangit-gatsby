    ...
    return (
        <>
            ...
            <div className="text-sm md:flex-grow md:text-right">
                <Link to="/" className="block mt-4 mr-4 md:inline-block font-medium md:mt-0 text-gray-300 focus:outline-none">Home</Link>
                <Link to="/projects" className="block mt-4 mr-4 md:inline-block font-medium md:mt-0 text-gray-300 focus:outline-none">Projects</Link>
