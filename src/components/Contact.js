    ...
    return (
        <>
            ...
            <div id="contact" className={`${ contactVisible ? "translate-y-0" : "-translate-y-full"} transform flex fixed h-full bg-dark z-50 w-full flex-grow flex-col justify-around transition duration-500 ease-in-out`}>
                <svg onClick={() => hideContact()} className="fill-current text-white absolute top-0 right-0 m-4 cursor-pointer" xmlns="https://www.w3.org/2000/svg" height="32" width="32" viewBox="0 0 24 24">
                ...
                <div className="w-11/12 md:w-9/12 lg:w-11/12 xl:w-10/12 mx-auto flex-wrap h-full lg:h-auto flex flex-col-reverse content-start lg:flex-row md:flex-no-wrap pt-12 md:py-16 xl:py-12">
                    ...
                    <div className="justify-start lg:justify-start flex flex-col flex-1 lg:flex-none px-4 pt-8 lg:py-0 w-full lg:w-1/2">
                        ...
                        <OutboundLink href="https://www.facebook.com/ShaneDMaglangit/" target="_blank" rel="noreferrer" className="flex items-center my-4">
                            <svg className="fill-current text-primary h-8 w-8 mr-2" width="54" height="54" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f" role="img" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 320 512">
                        ...
                        <OutboundLink  href="https://www.linkedin.com/in/ShaneMaglangit/" target="_blank" rel="noreferrer"  className="flex items-center my-4">
                            <svg className="fill-current text-primary h-8 w-8 mr-2" width="54" height="54" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in" role="img" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <OutboundLink href="https://github.com/shanemaglangit" target="_blank" rel="noreferrer" className="flex items-center my-4">
                            <svg className="fill-current text-primary h-8 w-8 mr-2" width="54" height="54" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github-alt" role="img" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 480 512">
